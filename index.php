    ...
    <div class="card">
     <div class="card-body">
      ...
      <?php if (isset($_GET['ok'])) {
       echo '<script>showToast("لطفا وارد شوید","success")</script>';
      }
      if (isset($_GET['not-ok'])) {
       echo '<script>showToast("لطفا وارد شوید","warning")</script>';
      }
        ...
        <div class="row mt-3" id="cap-container" style="width: 96%;align-items: end">
         <div class="w-50">
          ...
          <input type="text" id="captcha-code" class="form-control" name="captcha-code"
                 ...
                 aria-describedby="captcha-code" tabindex="1" required>
         </div>
         <div class="w-25">
          <img src="assets/captcha/cap.php" class="cap-img" style="border: 1.8px solid #d9dee3;border-radius: 5px">
         </div>
        </div>
       </div>
       <div class="mb-3">
