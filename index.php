<?php
  ...
  if (isset($_COOKIE['logedIn'])) {
    $_SESSION['logedIn'] = "وارد شدید";
    header("Location: html/dashboard.php");
  }
  if (isset($_POST['login-btn'])) {
    if (isset($_POST['captcha-code']) and $_POST['captcha-code'] == $_SESSION['captcha-code']) {
      ...
      $_GET['not-ok'] = "نام کاربری یا رمز عبور وارد نشده است";
    }
  }
        ...
        <div class="card">
          <div class="card-body">
            ...
            <?php if (isset($_GET['ok'])) {
              echo '<script type="text/javascript">toastr.warning("نام کاربری یا رمز عبور نادرست است")</script>';
            }
              if (isset($_GET['not-ok'])) {
                echo '<script type="text/javascript">toastr.warning("نام کاربری یا رمز عبور نادرست است")</script>';
              }
              if (@$_SESSION['first-login']) {
                echo '<script type="text/javascript">toastr.warning("نام کاربری یا رمز عبور نادرست است")</script>';
            ...
            <form id="formAuthentication" class="mb-3" method="POST">
              ...
              <div class="mb-3 form-password-toggle">
                ...
                <div class="row mt-3" id="cap-container" style="width: 96%;align-items: end">
                  <div class="w-50">
                    <label class="form-label" for="password">کد امنیتی</label>
                    <input type="text" id="captcha-code" class="form-control" name="captcha-code"
                           placeholder="کد امنیتی"
                           aria-describedby="captcha-code" tabindex="1" required onkeyup="chechCap(this.value)">
                  </div>
                  <div class="w-25">
                    <img src="assets/captcha/cap.php" class="cap-img"
                         style="border: 1.8px solid #d9dee3;border-radius: 5px">
                  </div>
                </div>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-100" onclick="checkCaptcha()" type="submit" name="login-btn"
                        tabindex="1">ورود
                </button>
              </div>
            </form>
