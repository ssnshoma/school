                ...
                <div class="card">
                  <div class="d-flex align-items-center row">
                    <div class="col-sm-10 m-auto">
                      <div class="card-body">
                        <h5 class="card-title text-primary">مدرسه را انتخاب کنید</h5>
                        <p>برای ثبت نام دانش آموز بر اساس مدرسه و کلاس انتخاب کنید</p>
                        <div class="input-group">
                          <form action="single-reg1.php" class="w-75 m-auto mt-3">
                            <select name="sel-school" style="text-align: right;" class="form-select mb-4"
                                    id="inputGroupSelect01">
                              <option selected style="direction: rtl" disabled> انتخاب کنید</option>
                              <?php
