                  ...
                  <div class="d-flex align-items-end row">
                    <div class="">
                      <div class="card-body">
                        ...
                        <p class="mb-4"> لیست کلاس های ثبت شده </p>
                        <div class="col-12">
                          <table class="table">
                            <thead>
                            <tr>
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="">
                      <div class="card-body">
                        ...
                        <form method="post">
                          <div class="row mb-2">
                            <label style="font-size: 17px" class="form-label" for="name">نام کلاس</label>
                            <div class="col-sm-12">
                          ...
                          <div class="row mb-2">
                            ...
                            <div class="col-sm-12">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="پایه را وارد کنید(به صورت عددی)" name="grade">
                            </div>
                          </div>
                          <div class="row mb-2">
                        ...
                        <form method="post">
                          <div class="row mb-4">
                            <div class="col-sm-10">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="نام کلاس را وارد کنید" value="<?php echo $nam; ?>" name="cname-e">
                            </div>
                          ...
                          <div class="row mb-4">
                            <div class="col-sm-10">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="پایه را وارد کنید(به صورت عددی)" name="cgrade-e"
                                     value="<?php echo $grad; ?>">
                            </div>
                          ...
                          <div class="row justify-content-center">
                            <div class="col-sm-12 mt-3 mb-2">
                              <button name="submit-btn-c" type="submit" class="btn btn-primary d-block m-auto">ثبت
                              </button>
                            </div>
                          </div>
                        </form>
