                  ...
                  <div class="d-flex align-items-end row">
                    <div class="">
                      <div class="card-body">
                        ...
                        <p class="mb-4"> لیست مدارس ثبت شده </p>
                        <div class="col-12">
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="">
                      <div class="card-body">
                        ...
                        <form method="post">
                          <div class="row mb-2">
                            <label style="font-size: 17px" class="form-label" for="name">نام</label>
                            <div class="col-sm-12">
                          ...
                          <div class="row mb-2">
                            ...
                            <div class="col-sm-12">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="نام و نام خانوادگی مدیر" name="manager-name">
                            </div>
                          </div>
                          <div class="row mb-2">
                          ...
                          <div class="row justify-content-center">
                            <div class="col-sm-12 mt-3 mb-2">
                              <button name="submit-btn" type="submit" class="btn btn-primary d-block m-auto">ثبت
                              </button>
                            </div>
                          </div>
                        </form>
                        ...
                        <form method="post">
                          <div class="row mb-4">
                            <div class="col-sm-10">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="نام مدرسه را وارد کنید" value="<?php echo $nam; ?>" name="name-e">
                            </div>
                            <label style="font-size: 17px" class="col-sm-2 col-form-label" for="name">نام</label>
                          </div>
                          <div class="row mb-4">
                            <div class="col-sm-10">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="نام و نام خانوادگی مدیر" name="manager-name-e"
                          ...
                          <div class="row mb-4">
                            <div class="col-sm-10">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="شماره مدرسه" name="phone-e" value="<?php echo $number; ?>">
                            </div>
                            <label style="font-size: 17px" class="col-sm-2 col-form-label" for="phone">تلفن</label>
                          </div>
                          <div class="row mb-4">
                            <div class="col-sm-10">
                              <input style="text-align: right" type="text" class="form-control"
                                     id="basic-default-name"
                                     placeholder="آدرس" name="address-e" value="<?php echo $addr; ?>">
                            </div>
                            <label style="font-size: 17px" class="col-sm-2 col-form-label"
                                   for="basic-default-name">آدرس</label>
                          </div>
                          ...
                          <div class="row justify-content-center">
                            <div class="col-sm-12 mt-3 mb-2">
                              <button name="submit-btn-e" type="submit" class="btn btn-primary d-block m-auto">ثبت
                              </button>
                            </div>
                          </div>
                        </form>
