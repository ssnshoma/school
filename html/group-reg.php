...
if (isset($_POST['save_multiple_data']) and $_POST['codemeli'] != "") {
 ...
 foreach ($codemeli as $index => $codemeli) {
  ...
  if ($rowcount <= 0) {
   ...
   ?>
   <script> toastr.warning("دانش آموز <?php echo $s_fname . " " . $s_lname?> ثبت نام نشد کد ملی قبلا ثبت شده ") </script>
   <?php
  }
 }
}
            ...
            <form method="post" class="w-75 m-auto mt-2" style="direction: rtl">
             ...
             <div class="row border-bottom mb-4">
              <div class="col-md-3">
               ...
               <input type="text" class="mb-4 input" name="codemeli[]" required tabindex="3">
              </div>
              <div class="col-md-3">
