        ...
        <div class="d-flex align-items-center row">
         <div class="col-sm-12 m-auto">
          <div class="card-body">
           ...
           <p class="mt-4">برای ثبت نام دانش آموز به صورت گروهی ابتدا مدرسه و کلاس انتخاب کنید سپس موارد را تکمیل
            کنید</p>
             ...
             <?php
               ...
               if (isset($_POST['save_multiple_data'])) {
                 ...
                 foreach ($codemeli as $index => $codemeli) {
                   ...
                   <?php } else { ?>
                    <div class="alert alert-primary w-50 block p-1 mb-1 mt-3" style="direction: rtl;margin-left: auto">
                     دانش آموز
