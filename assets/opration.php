            ...
            <form method="post" class="w-75 m-auto mt-2" style="direction: rtl">
             ...
             <div class="row">
              <div class="col-md-6">
               ...
               <input name="grade" class="input mb-4" id="grade" value="<?php print $SearchRow['grade'] ?>"
                      tabindex="8">
              </div>
              <div class="col-md-6">
               <label for="grade" class="pb-2">رشته</label>
               <input name="major" class="input mb-4" id="major" value="<?php print $SearchRow['major'] ?>"
                      tabindex="4">
              </div>
             </div>
             <div class="row">
              <div class="col-md-6">
               ...
               <input type="text" class="mb-4 input" name="codemeli" value="<?php print $SearchRow['codemeli'] ?>"
                      tabindex="5">
              </div>
              <div class="col-md-6">
               <label for="fname" class="pb-2">نام</label>
               <input type="text" class="mb-4 input" name="fname" value="<?php print $SearchRow['fname'] ?>"
                      tabindex="6">
              </div>
             </div>
             <div class="row">
              <div class="col-md-6">
               ...
               <input type="text" class="mb-4 input" name="lname" value="<?php print $SearchRow['lname'] ?>"
                      tabindex="7">
              </div>
              <div class="col-md-6">
             ...
             <?php
              ...
              <div class="container" dir="rtl">
               ...
               <div>
                ...
                <strong class="border-bottom" id="deleted"><?php print @$SearchRow['fathername'] ?></strong>
